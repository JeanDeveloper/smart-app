...
class CardGeneralDocumentC extends StatelessWidget {

  final GeneralDocumentContractor document;
  final ContractorRequest  request;
  const CardGeneralDocumentC({super.key, required this.document, required this.request});
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                width: size.width * .04, 
                color: ColorUtils.findColorFromDocumentC(document.estado),
              ),
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(StringUtils.converString(document.nombreOriginal), style: Theme.of(context).textTheme.bodySmall, maxLines: 2, overflow: TextOverflow.ellipsis,),
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            //       showSheetMultiSelect(context, request.cabecera, document.codDocumento );
                            //     },
                            //     child: ButtonIcon(
